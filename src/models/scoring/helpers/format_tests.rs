#[cfg(test)]
mod tests {
    use super::{calibrate_recommendation, evaluate_confidence_score, evaluate_direction_score};
    use crate::models::{
    ...
    fn single_tool_failure_does_not_trigger_missing_core_data_cap_when_core_is_present() {
        ...
        result.artifacts.analyst_runtime_states = vec![crate::models::AnalystRuntimeState {
            key: "news".to_string(),
            tool_history: vec![crate::models::ToolObservation {
    ...
    fn direction_penalty_can_block_marginal_buy_upgrade() {
        let profile = crate::models::scoring::CalibrationProfile::default();
        let calibrated = crate::models::scoring::calibrate_recommendation_with_profile(
            "Hold",
            16,
            70,
            65,
