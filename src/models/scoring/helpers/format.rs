...
#[cfg(test)]
mod tests {
    use super::super::super::{calibrate_recommendation, evaluate_confidence_score, evaluate_direction_score};
    use crate::{
    ...
    fn single_tool_failure_does_not_trigger_missing_core_data_cap_when_core_is_present() {
        ...
        result.artifacts.analyst_runtime_states = vec![crate::AnalystRuntimeState {
            key: "news".to_string(),
            tool_history: vec![crate::ToolObservation {
