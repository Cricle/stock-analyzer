use sa_models::{AnalysisResult, DiagnosisIssue, Rating};
...
impl ConsistencyValidator {
    ...
    fn fix_risk_reward(result: &mut AnalysisResult) -> Vec<DiagnosisIssue> {
        ...
        result.report.decision_view.target_reference =
            sa_models::LocalText::new(format!("{:.2}", new_target));
    ...
    fn fill_missing_fields(result: &mut AnalysisResult) -> Vec<DiagnosisIssue> {
        ...
        if !has_buy_paths && !has_sell_paths {
            use sa_models::{ActionScenarioPath, LocalText};
...
mod tests {
    ...
    fn test_risk_reward_widening() {
        ...
        result.report.decision_view.target_reference = sa_models::LocalText::new("103.00");
    ...
    fn test_no_issues_on_clean_result() {
        ...
        result.report.decision_view.target_reference = sa_models::LocalText::new("120.00");
