...
mod plans_tests {
    ...
    fn calibration_summary_serde_roundtrip() {
        let c = CalibrationSummary {
            ...
            setup_match_quality: ScoreDimension { score: 8, max_score: 10, rationale: LocalText::default() },
            setup_direction_alignment: ScoreDimension { score: 7, max_score: 10, rationale: LocalText::default() },
