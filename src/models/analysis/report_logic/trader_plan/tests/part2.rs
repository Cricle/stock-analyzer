    ...
    fn news_diagnostics_flag_source_concentration_and_weak_fetch_coverage() {
        let result = AnalysisResult {
            ...
            artifacts: crate::models::AnalysisArtifacts {
                analyst_runtime_states: vec![crate::models::AnalystRuntimeState {
                    key: "news".to_string(),
    ...
    fn availability_diagnostics_include_scenario_issues_and_market_minimums() {
        let result = AnalysisResult {
            ...
            agent_state: Default::default(),
            artifacts: crate::models::AnalysisArtifacts {
                scenario_context: crate::models::AnalysisScenarioContext::from_market_type("港股"),
                scenario_data: crate::models::AnalysisScenarioData {
    ...
    fn scenario_minimum_errors_become_execution_blocking_gaps() {
        let mut result = AnalysisResult {
            ...
            agent_state: Default::default(),
            artifacts: crate::models::AnalysisArtifacts {
                scenario_context: crate::models::AnalysisScenarioContext::from_market_type("美股"),
                scenario_data: crate::models::AnalysisScenarioData {
                    quote_status: "ok".to_string(),
                    candles_status: "ok".to_string(),
                    fundamentals_status: "missing".to_string(),
                    company_news_status: "missing".to_string(),
                    quote: Some(crate::types::QuoteSnapshot {
                        symbol: "TEST-US".to_string(),
        ...
        result.rebuild_report(&crate::models::scoring::CalibrationProfile::default());
        assert!(result
            .report
            .portfolio_decision
    ...
    fn availability_diagnostics_include_related_gap_linkage() {
        let mut result = AnalysisResult {
            ...
            market_type: "美股".to_string(),
            graph: Default::default(),
            agent_state: crate::models::AgentStateSnapshot {
