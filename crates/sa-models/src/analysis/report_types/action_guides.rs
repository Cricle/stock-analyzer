...
#[cfg(test)]
mod action_guides_tests {
    use super::*;

    #[test]
    fn direction_breakdown_serde_roundtrip() {
        let d = DirectionBreakdown {
            market: SignedScoreDimension { score: 15, min_score: -25, max_score: 25, rationale: LocalText::default() },
            fundamentals: SignedScoreDimension { score: 10, min_score: -25, max_score: 25, rationale: LocalText::default() },
            news: SignedScoreDimension { score: 5, min_score: -25, max_score: 25, rationale: LocalText::default() },
            sentiment: SignedScoreDimension { score: 3, min_score: -25, max_score: 25, rationale: LocalText::default() },
            risk_adjustment: SignedScoreDimension { score: -2, min_score: -15, max_score: 15, rationale: LocalText::default() },
            total_score: 31,
    ...
    fn action_breakdown_serde_roundtrip() {
        let b = ActionBreakdown {
            alignment: ScoreDimension { score: 14, max_score: 20, rationale: LocalText::default() },
            execution_levels: ScoreDimension { score: 10, max_score: 15, rationale: LocalText::default() },
            sizing_discipline: ScoreDimension { score: 8, max_score: 15, rationale: LocalText::default() },
            horizon_clarity: ScoreDimension { score: 7, max_score: 10, rationale: LocalText::default() },
            reward_to_risk: ScoreDimension { score: 12, max_score: 15, rationale: LocalText::default() },
            total_score: 51,
        };
