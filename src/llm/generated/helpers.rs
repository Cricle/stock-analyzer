...
pub fn extract_entry_price_from_texts(texts: &[&str]) -> Option<f64> {
    extract_first_price_after_keywords(texts, &["回踩", "承接", "支撑", "站稳"])
}

pub fn extract_stop_loss_from_texts(texts: &[&str]) -> Option<f64> {
...
pub fn extract_price_target_from_texts(texts: &[&str]) -> Option<f64> {
