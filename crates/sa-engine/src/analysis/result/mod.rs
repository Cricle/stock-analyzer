...
impl crate::TaskManager {
    ...
    pub(crate) async fn refresh_structured_report_snapshot(
        ...
        let calibration_profile = if use_market_profile {
            crate::memory::derive_calibration_profile(&market_entries)
        } else {
            crate::memory::derive_calibration_profile(&resolved_entries)
        };
        ...
        result.artifacts.memory_context.resolved_setup_tags = sa_models::derive_setup_tags(
    ...
    pub(crate) async fn run_agent_graph(
        ...
        crate::analysis::runtime::TradingAgentsGraph::new(
            self,
            params,
            quote,
            fundamentals,
