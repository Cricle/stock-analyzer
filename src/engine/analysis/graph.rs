...
use crate::engine::llm::{GeneratedDebateTurn, GeneratedRoleReport};
use crate::models::{AgentReportNode, AnalysisCheckpoint, AnalysisResult, DebateTurn};
...
pub(crate) fn push_analyst_node(result: &mut AnalysisResult, node: GeneratedRoleReport) {
    ...
    let (up_probability, down_probability, sideways_probability) =
        crate::engine::llm::parse::normalize_probability_triplet(
            &node.up_probability,
