...
pub(super) fn format_fundamental_metrics(sd: &sa_models::AnalysisScenarioData) -> String {
...
pub(super) fn format_volume_profile(sd: &sa_models::AnalysisScenarioData) -> String {
