...
pub struct AnalysisScenarioData {
    ...
    #[serde(default)]
    pub quote: Option<sa_types::QuoteSnapshot>,
    #[serde(default)]
    pub fundamentals: Option<sa_types::FundamentalsSnapshot>,
    #[serde(default)]
    pub company_news: Vec<sa_types::NewsItem>,
    #[serde(default)]
    pub candles: Vec<sa_types::CandlePoint>,
    #[serde(default)]
