...
use super::{
    ...
    SectorConstituent, SectorSnapshot, StockSearchResult, f64_to_dec, opt_f64_to_dec,
    wire::{
...
impl MarketDataClient {
    ...
    pub(crate) async fn fetch_a_share_eastmoney_candles(
        ...
        let payload: crate::wire::EastmoneyKlineEnvelope = response
            .json()
            .await
...
impl MarketDataClient {
    ...
    pub(super) async fn fetch_a_share_fundamentals(
        ...
        let eastmoney_equity: Option<Decimal> = eastmoney_balance
            .as_ref()
        ...
        let eastmoney_assets: Option<Decimal> = eastmoney_balance
            .as_ref()
        ...
        Ok(FundamentalsSnapshot {
            ...
            operating_income_usd: opt_f64_to_dec(
                fina_indicator.and_then(|row| row.optional_f64("op_of_gr")),
            ),
