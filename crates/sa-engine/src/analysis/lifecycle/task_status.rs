fn task_to_summary(task: sa_models::PersistedTask) -> sa_models::AnalysisTaskSummary {
    sa_models::AnalysisTaskSummary {
...
use sa_models::{AnalysisResult, ResultStage, TaskStatus, TaskStatusResponse};
...
impl TaskManager {
    ...
    pub(crate) fn spawn_event_forwarder(
        _task_id: &str,
        _sender: broadcast::Sender<sa_models::TaskEvent>,
    ) {
