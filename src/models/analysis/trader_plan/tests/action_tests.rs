...
use rust_decimal::Decimal;
    ...
    fn publishable_summary_reference_filters_template_fragments() {
        assert!(!super::super::is_publishable_summary_reference("确认后再评估上行空间"));
        assert!(!super::super::is_publishable_summary_reference(
            "升级为可执行看多需同时满足：财务口径确认完整"
        ));
        assert!(super::super::is_publishable_summary_reference("311.4上方有效突破"));
        assert!(super::super::is_publishable_summary_reference("跌破270.55"));
    }
    ...
    fn authoritative_summary_skips_unpublishable_confirmation_and_target_fragments() {
        ...
        .authoritative_summary(
            ...
            40,
            &super::super::CoreResearchCall::Neutral,
            &DecisionView {
