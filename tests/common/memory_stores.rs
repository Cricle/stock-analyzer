...
use sa_models::{
    AnalysisResult, AnalysisStore, CacheEntry, CacheStore, CheckpointInfo, CheckpointStore,
    GuidanceRule, GuidanceStore, PersistedTask, SingleAnalysisRequest, StoredAnalysisSummary,
    StoredCheckpoint, TaskStatus,
};
...
impl CheckpointStore for InMemoryCheckpointStore {
    ...
    async fn load_checkpoint(&self, task_id: &str) -> anyhow::Result<Option<StoredCheckpoint>> {
        ...
        // Return the latest checkpoint for this task_id
        Ok(checkpoints
            .iter()
