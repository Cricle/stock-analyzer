...
mod tests {
    ...
    fn test_cache_key_format() {
        let key = GuidanceStore::cache_key("2024-01-15", "a_share");
        assert_eq!(key, "tradingagents:guidance:report:2024-01-15:a_share");
    }
    ...
    #[test]
    fn test_stale_key_format() {
        let key = GuidanceStore::stale_key("2024-01-15", "us_equity");
        assert_eq!(
            key,
            "tradingagents:guidance:report:2024-01-15:us_equity:stale"
        );
    }

    #[test]
    fn test_prepared_key_format() {
        let key = GuidanceStore::prepared_key("2024-01-15", "hong_kong");
        assert_eq!(key, "tradingagents:guidance:prepared:2024-01-15:hong_kong");
    }

    #[test]
    fn test_prepared_key_lowercase_market() {
        let key = GuidanceStore::prepared_key("2024-01-15", "A_Share");
        assert_eq!(key, "tradingagents:guidance:prepared:2024-01-15:a_share");
    }
}
