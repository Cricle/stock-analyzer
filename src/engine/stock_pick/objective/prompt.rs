...
pub(crate) fn build_prompt(
    ...
    format!(
        "You are a senior equity selector.\n\
         ...
         For each pick, write a detailed 150-300 word thesis covering: (1) core business quality and competitive moat, (2) valuation vs peers, (3) growth catalysts and timeline, (4) key risks. Ground every claim in the specific data provided.\n\
