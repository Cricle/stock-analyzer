...
pub struct TaskManager {
    ...
    pub broadcasters: Arc<RwLock<HashMap<String, broadcast::Sender<crate::models::TaskEvent>>>>,
...
impl TaskManager {
    ...
    pub async fn publish_task_event(&self, _task_id: &str, _event: &crate::models::TaskEvent) {
...
mod task_manager_tests {
    ...
    fn memory_snapshot_from_bundle_maps_fields() {
        let bundle = crate::engine::memory::MemoryContextBundleWithTags {
    ...
    fn memory_snapshot_from_bundle_default_bundle() {
        let bundle = crate::engine::memory::MemoryContextBundleWithTags::default();
        let snapshot = memory_snapshot_from_bundle(&bundle);
