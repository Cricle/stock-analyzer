...
//!
//! Aggregates news, market data, and historical memory
//! to produce structured daily guidance reports. Reports are cached
//! and summaries are stored for cross-day semantic retrieval.
...
pub use report::{
    DailyGuidanceGenerator, classify_impact, has_negation_before, sentiment_label, sentiment_score,
};
