...
use crate::models::{AnalysisResult, PersistedTask};
...
pub(super) struct CoreMarketData {
    pub quote: Option<crate::data::QuoteSnapshot>,
    pub fundamentals: Option<crate::data::FundamentalsSnapshot>,
    pub news_items: Vec<crate::data::NewsItem>,
    pub market_chart: crate::models::ReportMarketChart,
    pub fetch_diagnosis: Vec<serde_json::Value>,
}

impl TaskManager {
    pub(crate) const MARKET_DATA_TIMEOUT: std::time::Duration = std::time::Duration::from_secs(8);
    pub(crate) const MARKET_NEWS_TIMEOUT: std::time::Duration = std::time::Duration::from_secs(20);
