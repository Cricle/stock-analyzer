impl StructuredReport {
    pub(crate) fn from_result(
        ...
        let confidence_assessment = crate::models::scoring::evaluate_confidence_score(result);
        let direction_assessment = crate::models::scoring::evaluate_direction_score(result);
        let action_assessment = crate::models::scoring::evaluate_action_score(
            result,
            &trader_plan,
            &portfolio_decision,
        ...
        let structural_execution_boundary =
            crate::models::scoring::has_execution_boundary(&trader_plan, &portfolio_decision);
        ...
        let setup_direction_alignment = crate::models::scoring::score_setup_direction_alignment(result);
        ...
        let calibration = crate::models::scoring::calibrate_recommendation_with_profile(
        ...
        let threshold_tightened = crate::models::scoring::history_requires_caution(calibration_profile);
