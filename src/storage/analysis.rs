...
use crate::models::store::{AnalysisStore, StoredAnalysisSummary};
use crate::models::{AnalysisResult, PersistedTask, SingleAnalysisRequest};
...
fn row_to_task(row: sqlx::postgres::PgRow) -> anyhow::Result<PersistedTask> {
    ...
    let default_usage = crate::models::LlmTokenUsageSummary {
        total_requests: row
    ...
    Ok(PersistedTask {
        ...
        status: crate::models::TaskStatus::from_str(&status_str)
