...
use crate::engine::analysis::runtime::propagation::Propagator;
...
impl TradingAgentsGraph {
    pub(crate) async fn new(
        ...
        _quote: Option<&crate::data::QuoteSnapshot>,
        _fundamentals: Option<&crate::data::FundamentalsSnapshot>,
        _news_items: &[crate::data::NewsItem],
    ) -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            deep_llm: if crate::engine::config::analysis_debug_quick_only() {
    ...
    pub(crate) async fn execute(&self, result: &mut AnalysisResult) -> anyhow::Result<()> {
        ...
        let thread_id = crate::engine::checkpoint::TaskCheckpointStore::thread_id(
            &result.task_id,
            &result.symbol,
        ...
        *result = deserialize_result(
        ...
        result.artifacts.runtime_nodes = self
            ...
            .await?
            .into_iter()
            .map(|write| crate::models::RuntimeNodeTrace {
                stage: write.stage,
                node: write.node,
                step: write.step,
