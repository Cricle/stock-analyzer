...
pub(super) fn summarize_tool_observation(item: &crate::models::ToolObservation) -> String {
    if !item.success {
...
pub(crate) fn summarize_stock_data_output(output: &str) -> String {
...
pub(super) fn format_fundamental_metrics(sd: &crate::models::AnalysisScenarioData) -> String {
...
pub(super) fn format_volume_profile(sd: &crate::models::AnalysisScenarioData) -> String {
...
mod tests {
    ...
    fn summarize_stock_data_output_supports_pre_summarized_payload() {
        ...
        let summary = super::summarize_stock_data_output(output);
