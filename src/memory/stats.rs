...
pub struct VectorMemoryPayload {
    ...
    pub structured_risk: Option<StructuredRiskAssessment>,
    pub structured_reflection: Option<StructuredReflection>,
    pub trigger_checklist: Option<Vec<String>>,
    pub blocking_gaps: Option<Vec<String>>,
    pub setup_tags: Option<Vec<String>>,
