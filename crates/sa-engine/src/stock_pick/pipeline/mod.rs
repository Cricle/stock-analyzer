...
use crate::stock_pick::objective::{
...
pub async fn run(
    ...
    let guidance_context = match crate::guidance::GuidanceStore::from_env()
...
pub(crate) fn test_shortlist_candidates_for_news(
    ...
    let mut shortlisted = crate::stock_pick::scoring::shortlist_candidates_for_news(
        &rows
            .into_iter()
