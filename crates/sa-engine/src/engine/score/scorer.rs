...
mod tests {
    ...
    fn test_weighted_total_equal_weights() {
        ...
        let tech = DimensionScore { score: 80, reason: String::new(), reason_key: None };
        let fund = DimensionScore { score: 60, reason: String::new(), reason_key: None };
        let sent = DimensionScore { score: 40, reason: String::new(), reason_key: None };
        let llm = DimensionScore { score: 70, reason: String::new(), reason_key: None };
    ...
    fn test_weighted_total_unequal_weights() {
        ...
        let tech = DimensionScore { score: 90, reason: String::new(), reason_key: None };
        let fund = DimensionScore { score: 30, reason: String::new(), reason_key: None };
        let sent = DimensionScore { score: 30, reason: String::new(), reason_key: None };
        let llm = DimensionScore { score: 30, reason: String::new(), reason_key: None };
        let total = weighted_total(&w, &tech, &fund, &sent, &llm);
        assert_eq!(total, 60);
    }
    ...
    fn test_weighted_total_all_max() {
        ...
        let d = DimensionScore { score: 100, reason: String::new(), reason_key: None };
    ...
    fn test_weighted_total_all_min() {
        let w = ScoreWeights::default();
        let d = DimensionScore { score: 0, reason: String::new(), reason_key: None };
        let total = weighted_total(&w, &d, &d, &d, &d);
        assert_eq!(total, 0);
    }
}
